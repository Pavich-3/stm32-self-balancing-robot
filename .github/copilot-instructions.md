...
Two independent CMake projects in one repository. Each board is built separately.
The `shared/` folder contains code compiled into **both** projects.
 
```
stm32-self-balancing-robot/
│
├── shared/                             # Compiled into both boards
│   ├── comms_protocol.hpp              # TelemetryPacket, ParamPacket structs
│   └── robot_types.hpp                 # RobotState, MotorDirection enum class
│
├── F756ZG/                             # Independent CMake project — Control Core
│   ├── CMakeLists.txt                  # include_directories(../shared)
│   ├── F756ZG.ioc                      # CubeMX config — COMMIT THIS
│   ├── Core/                           # Generated by CubeMX — do not edit
│   │   ├── Inc/
│   │   │   ├── main.h
│   │   │   └── FreeRTOSConfig.h
│   │   └── Src/
...
│   ├── Middlewares/                    # FreeRTOS — generated by CubeMX
│   └── App/                            # Hand-written application code
│       ├── imu/
│       │   ├── Bmi270.hpp / .cpp
│       │   └── KalmanFilter.hpp / .cpp
│       ├── control/
│       │   ├── PidController.hpp / .cpp
│       │   └── BalanceController.hpp / .cpp
│       ├── motors/
│       │   ├── MotorController.hpp / .cpp
│       │   └── Encoder.hpp / .cpp
│       ├── comms/
│       │   └── UartComms.hpp / .cpp
│       └── robot_config.hpp            # All constexpr tuning parameters
│
├── L432KC/                             # Independent CMake project — Interface
│   ├── CMakeLists.txt                  # include_directories(../shared)
│   ├── L432KC.ioc                      # CubeMX config — COMMIT THIS
│   ├── Core/                           # Generated by CubeMX — do not edit
...
│
├── .gitignore
├── CLAUDE.md                           # = this file (symlink or copy)
└── README.md
```
...
```bash
# Control core
cd F756ZG && mkdir build && cd build
cmake .. -DCMAKE_TOOLCHAIN_FILE=../arm-none-eabi.cmake
make -j4
 
# Interface
cd L432KC && mkdir build && cd build
cmake .. -DCMAKE_TOOLCHAIN_FILE=../arm-none-eabi.cmake
make -j4
```
...
```cpp
// F756ZG/App/comms/UartComms.cpp
#include "comms_protocol.hpp"   // від ../shared/ — той самий файл що й на L432KC
 
TelemetryPacket pkt{};
pkt.tilt_angle_deg = kalman.getAngle();
uart.send(pkt);
```
